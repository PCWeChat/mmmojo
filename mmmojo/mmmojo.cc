...
#if BUILDFLAG(IS_WIN)
void AppendMMSubProcessSwitchNative(void* mmmojo_env,
...
// read interface
const void* GetMMMojoReadInfoRequest(const void* mmmojo_readinfo,
...
const void* GetMMMojoReadInfoAttach(const void* mmmojo_readinfo,
...
void SetMMMojoWriteInfoMessagePipe(void* mmmojo_writeinfo,
...
void SetMMMojoWriteInfoResponseSync(void* mmmojo_writeinfo,
...
void* GetMMMojoWriteInfoRequest(void* mmmojo_writeinfo,
...
void* GetMMMojoWriteInfoAttach(void* mmmojo_writeinfo,
                               uint32_t attach_data_size) {
  void* attach_data = nullptr;
...
bool SwapMMMojoWriteInfoCallback(void* mmmojo_writeinfo,
                                 void* mmmojo_readinfo) {
  bool result = false;
